...
from cxai.xai.drsa.preprocessing import preprocess_data, normalize_vectors, get_songs_drsa
from cxai.xai.drsa.drsa import SubspaceOptimizer, objective_fn
from cxai.utils.all import HiddenPrints, Loader, round_down
...
def get_prototypes_toy(model: nn.Module, 
    ...
    #### TODO: use all4.txt to get prototypes
